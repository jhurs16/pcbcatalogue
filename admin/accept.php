...
if ($category == 'BSIT' || $category == 'BSIS') {
    $sql1 = "update LMS.record set Date_of_Borrow=curdate(),Due_Date=date_add(curdate(),interval 1 day),Renewals_left=1 where BookId='$bookid' and RollNo='$rollno'";
    ...
    $sql2 = "update LMS.record set Date_of_Borrow=curdate(),Due_Date=date_add(curdate(),interval 1 day),Renewals_left=1 where BookId='$bookid' and RollNo='$rollno'";
