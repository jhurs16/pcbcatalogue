...
if (isset($_SESSION['RollNo']) && isset($_SESSION['RoleType'])) {
    ...
    if ($roletype === 'Admin') {
        ...
        // RENEW
        $db->query("SELECT * FROM record AS rc, book, renew
        WHERE renew.BookId=book.BookId
        AND renew.RollNo=rc.RollNo 
        AND renew.BookId=rc.BookId");
        ...
        // RETURN
        $db->query("SELECT 
        return.BookId,return.RollNo,Title,datediff(curdate(),Due_Date) 
        AS x FROM `return`,book,record 
                        ...
                        <ul class="list-unstyled menu-categories" id="accordionExample">
                            ...
                            <li class="menu">
                                ...
                                <ul class="collapse submenu list-unstyled" id="pages" data-bs-parent="#accordionExample">
                                    ...
                                    <li>
                                        <a href="./book-issue-requests.php"> Borrow Requests </a>
                                    </li>
                                    <li>
                                        <a href="./book-renew-requests.php"> Renew Requests </a>
                                    </li>
                                    <li class="active">
                                        <a href="./book-return-requests.php"> Return Requests </a>
                                    </li>
                                    <li>
                                                        ...
                                                        <div class="progress br-30">
                                                            ...
                                                            <td>
                                                                <p class="text-primary">
                                                                    <?php
                                                                    $msg_color = "primary";
                                                                    if (count($issue_request) <= 0) {
                                                                        $msg_color = "danger";
                                                                    }
                                                                    ?>
                                                                    <span class="shadow-none badge badge-<?php echo $msg_color; ?>">
                                                                        <?php echo count($issue_request) > 0 ? count($issue_request) : 0; ?>
                                                                    </span>
                                                                </p>
                                                            </td>
                                                        ...
                                                        <div class="progress br-30">
                                                            ...
                                                            <td>
                                                                <p class="text-primary">
                                                                    <?php
                                                                    $msg_color = "primary";
                                                                    if (count($renew_request) <= 0) {
                                                                        $msg_color = "danger";
                                                                    }
                                                                    ?>
                                                                    <span class="shadow-none badge badge-<?php echo $msg_color; ?>">
                                                                        <?php echo count($renew_request) > 0 ? count($renew_request) : 0; ?>
                                                                    </span>
                                                                </p>
                                                            </td>
                                                            <td class="text-center ">
                                                        ...
                                                        <div class="progress br-30">
                                                            ...
                                                            <td>
                                                                <p class="text-primary">
                                                                    <?php
                                                                    $msg_color = "primary";
                                                                    if (count($return_request) <= 0) {
                                                                        $msg_color = "danger";
                                                                    }
                                                                    ?>
                                                                    <span class="shadow-none badge badge-<?php echo $msg_color; ?>">
                                                                        <?php echo count($return_request) > 0 ? count($return_request) : 0; ?>
                                                                    </span>
                                                                </p>
                                                            </td>
                                                            <td class="text-center ">
                                                        ...
                                                        <div class="progress br-30">
                                                            ...
                                                            <td>
                                                                <p class="text-success">
                                                                    ...
                                                                    <?php
                                                                    $msg_color = "primary";
                                                                    if (count($current_issuebooks) <= 0) {
                                                                        $msg_color = "danger";
                                                                    }
                                                                    ?>
                                                                    <span class="shadow-none badge badge-<?php echo $msg_color; ?>">
                                                                        <?php echo count($current_issuebooks) > 0 ? count($current_issuebooks) : 0; ?>
                                                                    </span>
                                                                </p>
                                                            </td>
                                                            <td class="text-center">
