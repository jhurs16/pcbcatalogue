        ...
        <div class="wrapper">
                ...
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <div class="container" style="padding-left: 650px; padding-top: 120px;">

                        <div class="module">
                            <div class="module-head">
                                <h3 style="font-size: 40px;">Student Details</h3>
                            </div>
                            <div class="module-body" style="font-size: 25px;">
                        <?php
                            $rno=$_GET['id'];
                            ...
                            $row=$result->fetch_assoc();    
                                ...
                                echo "<b><u>First Name:</u></b> ".$fname."<br><br>";
                                echo "<b><u>Last Name:</u></b> ".$lname."<br><br>";
                                echo "<b><u>Category:</u></b> ".$category."<br><br>";
                                echo "<b><u>Student No:</u></b> ".$rno."<br><br>";
