                    ...
                    <div class="col-lg-6 align-self-center pad-0">
                        <div class="form-section align-self-center">
                            <div class="logo">
                                ...
                                <h2 style="color: #fff; text-transform: uppercase;">Student Login</h2>
                            </div>
                            ...
                            <form method="POST" id="signinform">
                                <div class="form-group clearfix">
                                    ...
                                    <div class="form-box">
                                        <input type="text" name="RollNo" placeholder="Student No" class="form-control" id="rollno" aria-label="Roll Number">
                    ...
                    <div class="col-lg-6 align-self-center pad-0">
                        <div class="form-section align-self-center">
                            ...
                            <form method="POST" id="signupform">
                                <div class="form-group clearfix">
                                    <div class="form-box">
                                        <input type="text" name="studentname" placeholder="Name" class="form-control" id="studentname" aria-label="Student Name">
                                        <i class="flaticon-user-1"></i>
                                    </div>
                                </div>
                                <div class="form-group clearfix" id="emailidcon">
                                    ...
                                    <div class="form-box">
                                        <input type="email" name="signupemail" placeholder="Email" class="form-control" id="signupemail" aria-label="Email">
                                        <i class="flaticon-email"></i>
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    <div class="form-box">
                                        <input name="password" type="password" class="form-control" autocomplete="off" id="signuppassword" placeholder="Password" aria-label="Password">
                                        <i class="flaticon-password"></i>
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    <div class="form-box">
                                        <input type="text" class="form-control" name="phonenumber" placeholder="Phone Number (e.g., 09123456789)" required pattern="^09\d{9}$" title="Must start with 09 and be 11 digits long" autocomplete="off" id="phonenumber"><i class="flaticon-phone"></i>
                                    </div>
                                </div>
                                <div class="form-group clearfix">
                                    <div class="form-box">
                                        <input type="text" class="form-control" id="studentnumber" name="studentnumber" placeholder="Student Number (e.g., 12-12345)" required pattern="^\d{2}-\d{5}$" title="Format: 12-12345"><i class="fi fi-rr-phone-rotary"></i>
                                    </div>
                                </div>
                                ...
                                <div class="form-group clearfix">
                                    <button type="submit" class="btn btn-primary btn-lg btn-theme w-100">Sign Up</button>
                                </div>
                            </form>
