        ...
        <div class="wrapper">
                <div class="row">
                    ...
                    <div class="span9">
                         ...
                         <div class="container" style="padding-left: 650px; padding-top: 120px;font-size: 30px; font-family: cursive;">

                        <div class="module">
                            <div class="module-head">
                                <h3 style="font-size: 50px;">Book Details</h3><br><br>
                            </div>
                        ...
                        <?php
                            ...
                            $row=$result->fetch_assoc();    
                                ...
                                echo "<br><br>";
                                echo "<br><b>Publisher:</b> ".$publisher."<br><br>";
                                echo "<br><b>Year:</b> ".$year."<br><br>";
                                echo "<br><b>Availability:</b> ".$avail."<br><br>";
                       ...
                       <br> <a href="book.php" class="btn btn-primary" style="font-size:20px; width:10%">Go Back</a>                             
                               </div>
                           </div>
                            </div>
                    <!--/.span3-->
