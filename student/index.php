...
INNER JOIN publisher pub ON pub.publisherid = b.publisher;");
        ...
        $db->query("SELECT * FROM borrowrecords AS br where status = 'borrowed' and userid = ? order by borrowdate desc");
        $db->bind(1, $_SESSION['RollNo']);
                                    ...
                                    <div class="user-profile">
                                        <div class="widget-content widget-content-area">
                                            <div class="d-flex justify-content-between">
                                                <h3 class="">Profile</h3>
                                                <a href="./user/user-account-settings" class="mt-2 edit-profile"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
