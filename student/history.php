            ...
            <div class="Search">
                <form class="form-horizontal row-fluid" action="history.php" method="post">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="title" name="title" placeholder="Enter Book Name/Book Id." class="span8" style="font-size: 20px" required>
                ...
                //     $s = $_POST['title'];
                //     $sql = "select * from LMS.record,LMS.book where RollNo = '$rollno' and Date_of_Borrow is NOT NULL and Date_of_Return is NOT NULL and book.Bookid = record.BookId and (record.BookId='$s' or Title like '%$s%')";
                // } else
                //     $sql = "select * from LMS.record,LMS.book where RollNo = '$rollno' and Date_of_Borrow is NOT NULL and Date_of_Return is NOT NULL and book.Bookid = record.BookId";
