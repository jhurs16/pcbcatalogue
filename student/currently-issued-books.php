    ...
    <body class="layout-boxed">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="">
                                                            ...
                                                            if ($renewals) {
                                                            ?>
                                                                <!-- <button class="btn btn-success mb-2 me-2">Renew</button> -->
                                                                <button class="btn btn-success mb-2 me-2" onclick="issueBook(<?php echo $bookid; ?>, '<?php echo $rollno; ?>', 'renew')">Renew</button>
                                                            <?php } ?>
                                                            <!-- <button class="btn btn-info mb-2 me-1 ml-auto">Return</button> -->
                                                            <button class="btn btn-info mb-2 me-1" onclick="issueBook(<?php echo $bookid; ?>, '<?php echo $rollno; ?>', 'issue')">Return</button>
        ...
        <script>
            ...
            function issueBook(bookId, rollno, actions) {
                let act = actions === 'issue' ? 'Return' : 'Renew';
                const swalWithBootstrapButtons = Swal.mixin({
                    customClass: {
                        confirmButton: "btn btn-success",
                        cancelButton: "btn btn-danger"
